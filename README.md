...
## Jekyll Native Structure
```
scarver2.github.io/ (hyde branch)
├── _config.yml
├── _layouts/
│   ├── default.html
│   └── post.html
...
│   └── projects.yml
├── _posts/
│   └── 2024-02-14-youtube-video.md
├── assets/
├── index.html              # Homepage
├── toolbox.md              # Auto becomes /toolbox/
├── credits.md              # Auto becomes /credits/
├── repos.md                # Auto becomes /repos/
├── rails.md                # Auto becomes /rails/
